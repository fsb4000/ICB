...
contains(COFFEECOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += COFFEECOIN_NEED_QT_PLUGINS
...
HEADERS += src/qt/coffeecoingui.h \
    ...
    src/qt/coffeecoinaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
    ...
    src/qt/coffeecoinamountfield.h \
    src/wallet.h \
    src/keystore.h \
...
SOURCES += src/qt/coffeecoin.cpp src/qt/coffeecoingui.cpp \
    ...
    src/qt/coffeecoinaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/coffeecoinstrings.cpp \
    src/qt/coffeecoinamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
    src/qt/transactionfilterproxy.cpp \
    src/qt/transactionview.cpp \
    src/qt/walletmodel.cpp \
    src/coffeecoinrpc.cpp \
    src/rpcdump.cpp \
    src/rpcnet.cpp \
    src/rpcmining.cpp \
    src/rpcwallet.cpp \
...
# also add new translations to src/qt/coffeecoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/coffeecoin_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/coffeecoin-qt.rc
...
windows:RC_FILE = src/qt/res/coffeecoin-qt.rc
...
macx:ICON = src/qt/res/icons/coffeecoin.icns
macx:TARGET = "coffeecoin-Qt"
