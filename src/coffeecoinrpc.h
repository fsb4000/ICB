...
#ifndef _COFFEECOINRPC_H_
#define _COFFEECOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Coffeecoin is not connected
...
/**
 * Coffeecoin RPC command dispatcher.
 */
class CRPCTable
{
private:
